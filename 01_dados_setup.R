...
# 01_dados_setup.R
#
# Pé do pipeline. Carrega arquivos DBC do SINAN, monta tabelas mestre e cacheia
# tudo em dados_base.rds para uso pelos módulos 02–05.
#
# Saída: dados_base.rds contendo lista com:
#   $ config        — ano_inicio, ano_fim, anos, n_anos, periodo_lbl
#   $ ref_muni      — códigos IBGE/SINAN dos 54 municípios do TM
#   $ sinan_tri     — casos confirmados de meningite, residentes do TM
#   $ sinan_br      — casos confirmados, BR inteiro (para referências)
#   $ pop_ibge      — população anual por município (wide)
#   $ pop_muni_idade — população por município × faixa etária (Censo 2022)
#   $ mapa          — sf object dos 54 municípios com casos/pop/taxas/EB/quadrantes
#   $ pesos         — listw (matriz de vizinhança Queen W-padronizada)
#   $ pop_tm_faixa  — população do TM por ano × faixa
#
# Uso:
