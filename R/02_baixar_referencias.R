# =============================================================================
# 02_baixar_referencias — Populações de referência BR/MG/SE por (ano × sexo × faixa etária)
#
# Origem: Script original (não derivado de .Rmd)
# Depende: Conexão à API SIDRA (tabelas 6579 e 9514)
# Gera:    populacao_br_mg.rds
#
