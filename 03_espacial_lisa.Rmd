---
title: "Módulo 03 — Análise espacial (Moran global, LISA, Knox)"
...
# 2. Aglomerados locais (LISA) com correção FDR
...
```{r fig-incidencia, fig.cap=paste0("Figura 1. Taxas de incidência suavizadas (EB) por município — Triângulo Mineiro, ", periodo_lbl, ".")}
...
```{r fig-lisa, fig.cap=paste0("Figura 2. Aglomerados LISA com correção FDR (p < 0,05) — ", periodo_lbl, ".")}
